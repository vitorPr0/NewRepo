...
namespace ProjetoFinalVitor.Migrations
{
    ...
    [Migration("20231207105333_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Colaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.LocalRealizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Procedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Procedimentorealizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RealizacaoProcedimento");
                });

            modelBuilder.Entity("ProjetoFinalVitor.Models.Tipocolaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Tipoprocedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalVitor.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalVitor.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalVitor.Models.Tipocolaborador", "Tipocolaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalVitor.Models.Tipoprocedimento", "Tipoprocedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalVitor.Models.Procedimentorealizacao", b =>
                {
                    b.HasOne("ProjetoFinalVitor.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalVitor.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalVitor.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalVitor.Models.Procedimento", "Procedimento")
                        .WithMany()
