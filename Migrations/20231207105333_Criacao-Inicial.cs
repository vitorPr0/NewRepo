...
namespace ProjetoFinalVitor.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Localizacao_Cidade_CidadeId",
                        column: x => x.CidadeId,
                        principalTable: "Cidade",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealizacaoProcedimento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RealizacaoProcedimento_Cliente_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Cliente",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealizacaoProcedimento_Colaborador_ColaboradorId",
                        column: x => x.ColaboradorId,
                        principalTable: "Colaborador",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealizacaoProcedimento_Localizacao_LocalRealizacaoId",
                        column: x => x.LocalRealizacaoId,
                        principalTable: "Localizacao",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealizacaoProcedimento_Procedimento_ProcedimentoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealizacaoProcedimento_ClienteId",
                table: "RealizacaoProcedimento",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_RealizacaoProcedimento_ColaboradorId",
                table: "RealizacaoProcedimento",
                column: "ColaboradorId");

            migrationBuilder.CreateIndex(
                name: "IX_RealizacaoProcedimento_LocalRealizacaoId",
                table: "RealizacaoProcedimento",
                column: "LocalRealizacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_RealizacaoProcedimento_ProcedimentoId",
                table: "RealizacaoProcedimento",
